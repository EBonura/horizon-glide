...
function circle_event:draw_direction_arrow(target)
    ...
    local dx, dy = target.x - player_ship.x, target.y - player_ship.y
    local dist = dist_trig(dx, dy)
    ...
    local arrow_size, arrow_col = 6, 8
